          ...
          >
            ...
            {status === "authenticated" ? (
              <motion.button
                ...
                className={`mt-4 px-4 py-2 rounded-lg font-impact tracking-wider ${isFavorite ? "bg-red-500 hover:bg-red-600" : "bg-[#1ED760] hover:bg-[#1DB954]"}`}
              >
                {isFavorite ? "REMOVE FROM FAVORITES" : "ADD TO FAVORITES"}
              </motion.button>
            ) : (
              <p className="text-white font-impact tracking-wider mt-4">
